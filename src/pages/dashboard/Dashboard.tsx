  ...
  return (
    <>
      <Row gutter={30} className="dashboard-header">
        <Col xs={8}>
          <Panel className="trend-box bg-gradient-red">
            <img className="chart-img" src="../../images/vm.png" />
            <div className="title">VM utilisées</div>
            <div className="value">3</div>
          </Panel>
        </Col>
        <Col xs={8}>
          <Panel className="trend-box bg-gradient-green">
            <img className="chart-img" src="https://e7.pngegg.com/pngimages/620/880/png-clipart-vmware-vsphere-computer-software-virtualization-virtual-machine-vm-consulting-blue-angle.png" />
            <div className="title">Stockage restant</div>
            <div className="value">50 GO</div>
          </Panel>
        </Col>
        <Col xs={8}>
          <Panel className="trend-box bg-gradient-blue">
            <img className="chart-img" src="https://e7.pngegg.com/pngimages/620/880/png-clipart-vmware-vsphere-computer-software-virtualization-virtual-machine-vm-consulting-blue-angle.png" />
            <div className="title">VM disponibles restantes</div>
      ...
      <Row gutter={30}>
        <Col xs={16}>
          <BarChart
            title="Temps en moyenne d'utilisation"
            actions={
              <ButtonGroup>
                <Button active>Jour</Button>
